	...
	for(int z = 0; z < numeroVetor; z++){
		...
		switch(codigo){                      
			...
			case 2:                          //tela de instrucoes do jogo
				...
				printf("\nCaso o jogador queira terminar o jogo cedo, deverá digitar o número 404 em qualquer uma das entradas de coordenada para sair. Mantendo assim a pontuação obtida até o momento.");                //sem instrucoes ainda
				printf("\n\n");
